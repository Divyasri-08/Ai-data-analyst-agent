...
# -----------------------------
region_df = pd.read_csv("outputs/version_1_predefined_sql/04_churn_by_region.csv")
...
# -----------------------------
plan_df = pd.read_csv("outputs/version_1_predefined_sql/05_churn_by_subscription_plan.csv")
...
# -----------------------------
reason_df = pd.read_csv("outputs/version_1_predefined_sql/06_top_churn_reasons.csv")
